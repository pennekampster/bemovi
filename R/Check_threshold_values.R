...
#' then automatically opened in ImageJ. Depending on the video size, it might take some time to open the video and the thresholding menu. By playing with the treshold manually, the correct
#' value is determined and can be subsequently provided to the appropriate R functions performing the segmentation.
#' 
...
check_threshold_values <- function(to.data, raw.video.folder, ijmacs.folder, vid_select = 0, difference.lag, memory) {
