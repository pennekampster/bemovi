#' Modified function to link the particle coordinates through time; allows to specify a maximum amout of time for the
#' tracking to be specified, otherwise the job will be terminated (UNIX only version!!!!)
#' 
...
#' @param kill_after time in minutes after which tracking job should be terminated. Default -1 means no temporal restrictions.
